...
declare module "hornet-js-components/src/react-component-errors" {
	/**
	 ...
	 */
	export default function (ComponentConstructor: any): void;
...
declare module "hornet-js-components/src/tab/tab" {
	...
	class Tab extends HornetComponent<PropTypesNs.TabProps, any> {
	    ...
	    static propTypes: {
	        ...
	        isVisible: React.Requireable<any>;
	        forceRender: React.Requireable<any>;
	    };
	    static defaultProps: {
	        tabId: string;
	        panelId: string;
...
declare module "hornet-js-components/src/table/store/table-store" {
	...
	class TableStore extends BaseStore {
	    ...
	    static RECEIVE_UPDATE_DATA: string;
	    static RESET_TABLE_DATA: string;
	    /**
