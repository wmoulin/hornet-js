...
var MemoryStore = require("src/session/memory-store");
...
var SessionManager = (function () {
    ...
    SessionManager.middleware = function (options) {
        var options = options || {}, name = options.name || "NODESESSIONID", store = options.store || new MemoryStore, cookie = options.cookie || {}, trustProxy = options.proxy, alwaysSetCookie = options.alwaysSetCookie || false, saveUnmodifiedSession = options.saveUnmodifiedSession, secret = options.secret || "", sessionTimeout = options.sessionTimeout || 1800000, route = cookie.route || null;
        var cookieDestroy = {
